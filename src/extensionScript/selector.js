const selectors = {
    ...
    friend_count : ['h2.html-h2[dir="auto'],
    all_friends_div : ['div[aria-label="All friends"]'], 
    seperator : ['div[role="separator"]'],
    ...
    groupHeader : ['div[role="main"][aria-label="Preview of a group"]','div[aria-label="Group content"][role="main"]'],

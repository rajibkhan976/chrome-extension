...
const GroupListings = ({setShowDetailsFn, setHideDetailsFn, showDetails}) => {

  const groupLists = [
    {
      title: "Default by Friender",infos:
      "{executive director | co-founder | chief-executive }",
      message:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,",
    },
    {
      title: "Group Lorem Ipsum is simply dummy text ...",infos:
      "{executive director | co-founder | chief-executive }",
      message:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,",
    },
    {
      title: "Lorem Group Ipsum is simply dummy text ...",infos:
      "{executive director | co-founder | chief-executive }",
      message:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,",
    },
